    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Voici quelques-uns de mes projets récents. Chaque projet a été réalisé avec soin,
          en portant une attention particulière aux détails, à la performance et à l’expérience utilisateur.
        </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/benjamin-Dassonville"
          >
